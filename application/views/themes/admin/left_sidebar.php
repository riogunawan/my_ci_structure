<aside id="leftsidebar" class="sidebar">
    ...
    <div class="user-info">
        <div class="image">
            <img src="<?= base_url("assets/themes/AdminBSBMaterialDesign/") ?>images/user.png" width="48" height="48" alt="User" />
        </div>
    ...
    <div class="legal">
        <div class="copyright">
            &copy; 2016 - 2017 <a href="https://gurayyarar.github.io/AdminBSBMaterialDesign/" target="_blank">AdminBSB - Material Design</a>.
        </div>
        <div class="version">
            <b>Version: </b> 1.0.5
        </div>
